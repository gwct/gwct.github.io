	...
	<div class="pure-g" id="main_div_bio">
		...
		<div class="pure-u-15-24" id="bio_text">
			...
			<p align="justify">Outside of the lab, I have a passion for 
				...
				<span id="hidden"> and <img src="img/me/pip.jpg"></span><span id="hidden">animals<img src="img/me/iggy+wells.jpg"></span> in general. I volunteer every weekend at the local animal shelter to try and help
