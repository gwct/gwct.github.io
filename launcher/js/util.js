...
function getWeatherMA()
// Writes the weather widget.
{
    document.write("<a class='weatherwidget-io' href='https://forecast7.com/en/42d39n71d10/somerville/?unit=us' data-label_1='' data-icons='Climacons Animated' data-textcolor='#ffffff' data-font='Arimo'>BOSTON WEATHER</a>");
    !function(d,s,id){
        var js,fjs=d.getElementsByTagName(s)[0];
        if(!d.getElementById(id)){
            js=d.createElement(s);
