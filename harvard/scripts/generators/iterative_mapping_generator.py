                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <p>Pseudo-it is software written in the <a href="http://www.thegoodlab.org/" target="_blank">Good Lab</a> designed to 
                                mitigate the effects of reference bias by using an iterative mapping approach to generate pseudo-reference 
                                assemblies. It performs the following steps:
                            </p>
                            ...
                            <center><pre class="cmd"><code>pseudo_it -ref data/dmel-3R-reference/Drosophila_melanogaster.BDGP6.28.dna.chromosome.3R.fa -pe1 data/dpse-chr2-reads/illumina/pse-chr2_1.fastq.gz -pe2 data/dpse-chr2-reads/illumina/pse-chr2_2.fastq.gz -i 2 -p 4 -o dpse-pseudo-it</code></pre></center>
                            ...
                            <h3>01. More reads should map to the second iteration</h3>
                                ...
                                <div class="table-cont">
                                    <table class="cmd-table">
                                        <thead><th class="tcol-1">Command line parameter</th><th class="tcol-2">Description</th></thead>
                                        <tr>
                                            <td class="tcol-1">../scripts/avg_depth</td><td class="tcol-2">The path to the script.</td>
                                        </tr>
                                        <tr>
                                ...
                                <pre class="text"><code>Average read depth: 4.17527</code></pre> 

                                <p>Again, a modest increase from 3.9, but a step in the right direction, showing that iterative mapping improves read depth.</p>
...
title = "Iterative mapping - Harvard Bioindormatcs"
