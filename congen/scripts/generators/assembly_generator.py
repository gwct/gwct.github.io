                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <pre class="text"><code>The table.</code></pre>
                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <p>You'll learn more about BUSCO in the next session, but for now we'll just take a look at a sample output from our SPAdes Illumina assembly.</p>
                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <center><pre class="cmd"><code>samtools faidx assemblies/spades-illumina/scaffolds.fasta</code></pre></center>
                            ...
                            <p>This should run fairly quickly and will produce the file <code class="inline">assemblies/spades-illumina/scaffolds.fasta.fai</code> file that we can look at</p>

                            <center><pre class="cmd"><code>less -S assemblies/spades-illumina/scaffolds.fasta.fai</code></pre></center>
